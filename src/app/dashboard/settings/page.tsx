                    ...
                    <tbody>
                      {purchases.map((purchase) => (
                        <tr key={purchase.id} className="border-b">
                          ...
                          <td className="py-3 px-4 capitalize">{purchase.plan_type}</td>
                          <td className="py-3 px-4">${purchase.amount}</td>
                          <td className="py-3 px-4">{purchase.snippet_limit_added}</td>
                          <td className="py-3 px-4 capitalize">{purchase.status}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
